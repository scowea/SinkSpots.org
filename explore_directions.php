      ...
      <div class="content"> 
        <table width="100%" border="0" >
          <form action="#" onsubmit="showAddress(this.address.value); return false">
            <tr> 
              <td width=25% valign="middle" >Search for an address:</td>
              <td valign="middle"><input type="text" size="60" name="address" value="Anytown, USA" /> 
              </td>
              <td valign="middle"><input type="submit" value="Search" class= "submit"/></td>
            </tr>
          </form>
        </table>
        ...
        <div align="center"> 
          <table width="100%" border="0">
            ...
            <tr> 
              <td align="left" valign="middle" colspan="2"><b>Latitude:</b> <input type="text" name="latitude" id="latitude" value="<?php echo $latitude; ?>"/></td>
              <td align="left" valign="middle" colspan="2"><b>Longitude:</b> <input type="text" name="longitude" id="longitude" value="<?php echo $longitude; ?>"/></td>
            </tr>
            <tr> 
            ...
            <tr> 
              <td colspan="4">Update Currently Selected Spot With This Lat/Long: 
        ...
        <div align="center"> 
          <table width="100%" border="0">
            ...
            <tr> 
              <td>Update Currently Selected Spot To Be Initially Zoomed To This 
                Level: 
        ...
        <?PHP 
			...
			// roll through the lines and find this gage....
			while ($i < (count($spot_info) - 1))
			{
				// split this line into words...
				$stuff = preg_split('/,/', $spot_info[$i]); 
	  			
				echo $stuff[2] . ":" . $stuff[1] . ", " . $stuff[0] . "<br>";
				$i = $i + 1;
			}	
		?>
      </div>
