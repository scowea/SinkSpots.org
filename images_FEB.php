...
?>
        ...
        <div class="column1-unit">
			...
			$sql = "SELECT * FROM `images` WHERE `spot_id` = '" . $currently_selected_id . "' ORDER BY `image_id` ASC";
			...
			{ 
				...
				while($row = mysql_fetch_array($result, MYSQL_ASSOC))
				{
					...
					// set the variables
					echo ('<li class="img_stopper"><a  href="http://sinkspots/images/' . $spot_id . '/' . $image_filename . '" rel="prettyPhoto[gallery1]" title=""><img src="../images/' . $spot_id . '/thumbs/' . $image_filename . '" width="60" height="60"></a></li>');		
		...
		$(document).ready(function(){
			...
			$(".gallery:gt(0) a[rel^='prettyPhoto']").prettyPhoto({animationSpeed:'slow',slideshow:8000});			 
		});
		</script
        
              <br>
              <div align="center"> <?php echo "[<a href=image_maintenance.php?spot_id=" . $currently_selected_id . "&action=add><em><font color=#0000FF>Add New Image For This Spot</font></em></a>]"; ?> 
              </div>
              <hr>
